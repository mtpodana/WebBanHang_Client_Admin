...
function TableDonHang({ type, setType, donHang, setDonHang,loaiDon,setLoaiDon }) {
  ...
  }, [searchId, searchDate, searchTime,type,loaiDon]);
  const handleReset = () => {
    setSearchId("");
    setSearchDate("");
    setSearchTime("");
            ...
            <div className="row">
              <div className="col-sm-12 col-md-6">
                ...
                <div >
                  <select
                    value={loaiDon}
                    onChange={(e) => setLoaiDon(e.target.value)}
                  >
                    <option value={10}>Đơn hàng có tài khoản</option>
                    <option value={20}>Đơn hàng không có tài khoản</option>
                  </select>
                </div>
                </div>
              </div>
